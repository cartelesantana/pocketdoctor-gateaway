...
<?php include ('basicStructures/head.php');?>
    ...
    <main id="main">
          ...
          <div class="row gy-4">
            <div class="col-lg-6">
              ...
              <p>
                ...
                entrepreneurship development hub. OIC is an actor of digitala
              ...
              <div class="content ps-0 ps-lg-5">
                <ul>
                  <li>
                    ...
                    innovative projects holders in the digital sector to convert
                    thier projects into high potential companies,
                  </li>
                  <li>
                    <i class="bi bi-check-circle-fill"></i> transmit knowlwdge
            ...
            <div class="col-lg-6">
              <div class="stats-item d-flex align-items-center">
                ...
                <p>
                  ...
                  domains realted ton new technologies and digitalization
                </p>
              </div>
              <!-- End Stats Item -->
      ...
      <section id="call-to-action" class="call-to-action">
        <center>
          <video class="oicPub" width="600" height="500" autoplay muted loop>
